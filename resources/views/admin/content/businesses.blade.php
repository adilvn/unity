        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Businesses</h3>
                    <p class="text-subtitle text-muted">For Super Admin To Manage Businesses</p>
                </div>
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('businesses-status-update', ['id' => $user->id]) }}">
                                    ...
                                    <td class="d-flex justify-content-evenly">
                                        <a onclick="return confirm('Are you sure you want to delete this business?')" href="{{ route('delete-businesses', ['id' => $user->id]) }}" class="pt-2">
...
@section('bodyExtra')
    ...
    <script>
        $(function() {
            @if (Session::has('businesses-delete'))
            toastr.options = {
                'timeOut': '3000',
                'closeButton': true,
                'progressBar': true,
            }
            toastr.success("{{ Session::get('businesses-delete') }}");
            @endif
        });
    </script>
@endsection
